...
if mods["bobenemies"] then
  angelsmods.functions.add_gathering_turret_start_trigger{range = 60, type = "unit", name = "bob-big-electric-spitter"}
  angelsmods.functions.add_gathering_turret_start_trigger{range = 60, type = "unit", name = "bob-huge-explosive-spitter"}
  ...
  angelsmods.functions.add_gathering_turret_start_trigger{range = 60, type = "unit", name = "bob-giant-poison-spitter"}
