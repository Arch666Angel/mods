...
data:extend(
  {
    ...
    },
    {
      ...
      folding_speed = 0.05,
      folded_animation = angelsmods.functions.create_gathering_turret_extensions{frame_count=1, line_length=1, shift = {0, -0.46}, scale = 0.78},
      ...
      -- attack state
      --attacking_speed = 0.1,
      energy_glow_animation = angelsmods.functions.create_gathering_turret_shooting_glow{shift = {0, -0.46}, scale = 0.78},
      glow_light_intensity = 0.5, -- defaults to 0

      -- folding state
      folding_animation = angelsmods.functions.create_gathering_turret_extensions{run_mode = "backward", shift = {0, -0.46}, scale = 0.78},
      ...
      base_picture = angelsmods.functions.merge_layers(
        ...
        angelsmods.functions.create_gathering_turret_base{type = "laser", apply_runtime_tint = true, shift = {0, -0.46}, scale = 0.78}
      ),
      ...
      attack_parameters =
      {
        ...
        source_offset = angelsmods.functions.create_gathering_turret_beam_source_offset{offset = {0, -3.423489 / 4}, shift = {0, -0.46}, scale = 0.78},
        damage_modifier = 1,
        ammo_type =
        {
          category = "gathering",
      ...
      water_reflection = angelsmods.functions.create_gathering_turret_water_reflection{shift = {0, -0.46}, scale = 0.78}
    },
    {
      type = "beam",
      ...
      start = angelsmods.functions.create_gathering_turret_beam_start{flags = { "trilinear-filtering" }, blend_mode = "additive-soft"},
      ending = angelsmods.functions.create_gathering_turret_beam_end{flags = { "trilinear-filtering" }, blend_mode = "additive-soft"},
      head = angelsmods.functions.create_gathering_turret_beam_head{flags = { "trilinear-filtering" }, blend_mode = "additive-soft"},
      tail = angelsmods.functions.create_gathering_turret_beam_tail{flags = { "trilinear-filtering" }, blend_mode = "additive-soft"},
      body = angelsmods.functions.create_gathering_turret_beam_body{flags = { "trilinear-filtering" }, blend_mode = "additive-soft"},
