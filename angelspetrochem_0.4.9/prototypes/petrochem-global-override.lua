--OVERRIDE FOR BASE
	...
	angelsmods.functions.OV.disable_recipe({ "plastic-bar", "fill-crude-oil-barrel", "empty-crude-oil-barrel" })
...
--CONFIG OPTIONS OVERRIDE FOR REFINING   
	...
	if angelsmods.petrochem.enableacids then
	  ...
	  angelsmods.functions.OV.set_input("angelsore2-crystal", "liquid-hydrofluoric-acid", "fluid", 0.5)
	  angelsmods.functions.OV.remove_input("angelsore4-crystal", "liquid-sulfuric-acid")     
	  angelsmods.functions.OV.set_input("angelsore4-crystal", "liquid-hydrochloric-acid", "fluid", 0.5)
	  angelsmods.functions.OV.remove_input("angelsore5-crystal", "liquid-sulfuric-acid")     
	  angelsmods.functions.OV.set_input("angelsore5-crystal", "liquid-nitric-acid", "fluid", 0.5)
	end

--OVERRIDE FOR BOBs
if bobmods and bobmods.plates then
--BARRELING
   angelsmods.functions.OV.disable_technology({ "gas-canisters", "barrels" })  
