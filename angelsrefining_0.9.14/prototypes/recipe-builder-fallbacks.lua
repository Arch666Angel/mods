--FALLBACKS
	--CIRCUITS
	angelsmods.functions.RB.set_fallback("item", "t0-circuit", { { "block-electronics-1" }, { "basic-circuit-board" }, { "electronic-circuit" } })
	...
	--BUILDINGS
	--REFINING
	angelsmods.functions.RB.set_fallback("item", "crusher-0", { { "construction-frame-1" }, { "stone" } } )
	...
	angelsmods.functions.RB.set_fallback("item", "filter-2", { { "block-mprocessing-4", 3 }, { "filtration-unit" } } )
	...
	angelsmods.functions.RB.set_fallback("item", "thermal-1", { { "block-mprocessing-4", 5 } } )

	angelsmods.functions.RB.set_fallback("item", "salination-1", { { "block-mprocessing-3", 5 } } )
	angelsmods.functions.RB.set_fallback("item", "salination-2", { { "block-mprocessing-4", 5 }, { "salination-plant" } } )

	angelsmods.functions.RB.set_fallback("item", "treatment-1", { { "block-production-1", 5 } } )
	angelsmods.functions.RB.set_fallback("item", "treatment-2", { { "block-mprocessing-3", 5 }, { "hydro-plant" } } )
	...
	angelsmods.functions.RB.set_fallback("item", "sinteringo-1", { { "block-production-2", 3 } } )
	...
	--BIO PROCESSING
	angelsmods.functions.RB.set_fallback("item", "algaefarm-1", { { "block-production-1", 5 } } )
