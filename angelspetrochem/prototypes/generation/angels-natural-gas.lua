...
data.raw["map-gen-presets"]["default"]["rich-resources"].basic_settings.autoplace_controls["angels-natural-gas"] = { richness = "very-good"}
data.raw["map-gen-presets"]["default"]["rail-world"].basic_settings.autoplace_controls["angels-natural-gas"] = {frequency = "low", size = "high"}
