...
if mods["bobassembly"] then
  if data.raw["assembling-machine"]["chemical-plant-2"] then
    ...
    data.raw["assembling-machine"]["chemical-plant-2"].module_slots = 4
  end
  ...
  if data.raw["assembling-machine"]["chemical-plant-3"] then
    ...
    data.raw["assembling-machine"]["chemical-plant-3"].module_slots = 5
  end
  ...
  if data.raw["assembling-machine"]["chemical-plant-4"] then
    ...
    data.raw["assembling-machine"]["chemical-plant-4"].module_slots = 6
  end
...
if mods["bobassembly"] then
  if data.raw["assembling-machine"]["oil-refinery-2"] then
    ...
    data.raw["assembling-machine"]["oil-refinery-2"].module_slots = 3
  end
  ...
  if data.raw["assembling-machine"]["oil-refinery-3"] then
    ...
    data.raw["assembling-machine"]["oil-refinery-3"].module_slots = 4
  end
  ...
  if data.raw["assembling-machine"]["oil-refinery-4"] then
    ...
    data.raw["assembling-machine"]["oil-refinery-4"].module_slots = 5
  end
end
