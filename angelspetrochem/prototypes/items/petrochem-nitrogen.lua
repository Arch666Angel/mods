...
data:extend(
  {
    ...
    },
    {
      ...
      icons = angelsmods.functions.create_gas_fluid_icon({ "__angelspetrochem__/graphics/icons/molecules/ammonium-chloride.png", 72 }, "NHCl"),
      --icon_size = 32,
      subgroup = "petrochem-nitrogen-fluids",
      order = "f",
      default_temperature = 0,
    ...
    },
    {
      ...
      icons = angelsmods.functions.create_gas_fluid_icon({ "__angelspetrochem__/graphics/icons/molecules/chloramine.png", 72 }, "NHCl"),
      --icon_size = 32,
      subgroup = "petrochem-nitrogen-fluids",
      order = "j",
      default_temperature = 0,
