...
data:extend(
  {
    ...
    },
    {
      ...
      gas_temperature = 25,
      heat_capacity = "0.1KJ",
      base_color = angelsmods.functions.fluid_color({"c","h3"}),--{r = 0.35, g = 0.35, b = 0.35},
      flow_color = angelsmods.functions.fluid_color({"c","h3"}),--{r = 0.35, g = 0.35, b = 0.35},
      max_temperature = 100,
      pressure_to_speed_ratio = 0.4,
      flow_to_energy_ratio = 0.59
    },
    {
      ...
      gas_temperature = 25,
      heat_capacity = "0.1KJ",
      base_color = angelsmods.functions.fluid_color({"c2","h5"}),--{r = 0.4, g = 0.4, b = 0.4},
      flow_color = angelsmods.functions.fluid_color({"c2","h5"}),--{r = 0.4, g = 0.4, b = 0.4},
      max_temperature = 100,
      pressure_to_speed_ratio = 0.4,
      flow_to_energy_ratio = 0.59
    },
    {
      ...
      gas_temperature = 25,
      heat_capacity = "0.1KJ",
      base_color = angelsmods.functions.fluid_color({"c","h2"}),--{r = 0.1, g = 0.1, b = 0.1},
      flow_color = angelsmods.functions.fluid_color({"c","h2"}),--{r = 0.1, g = 0.1, b = 0.1},
      max_temperature = 100,
      pressure_to_speed_ratio = 0.4,
      flow_to_energy_ratio = 0.59
    },
    ...
    --CRACKING
    {
      ...
      flow_color = angelsmods.functions.fluid_color({"h","h4","o"}),--{r = 0.5, g = 0.3, b = 0.3},
      max_temperature = 100,
      pressure_to_speed_ratio = 0.4,
      flow_to_energy_ratio = 0.59
    },
    {
      ...
      gas_temperature = 25,
      heat_capacity = "0.1KJ",
      base_color = angelsmods.functions.fluid_color({"c","h2"}),--{r = 0.45, g = 0.45, b = 0.45},
      flow_color = angelsmods.functions.fluid_color({"c","h2"}),--{r = 0.45, g = 0.45, b = 0.45},
      max_temperature = 100,
      pressure_to_speed_ratio = 0.4,
      flow_to_energy_ratio = 0.59
    },
    {
      ...
      gas_temperature = 25,
      heat_capacity = "0.1KJ",
      base_color = angelsmods.functions.fluid_color({"c","h"}),--{r = 0.5, g = 0.5, b = 0.5},
      flow_color = angelsmods.functions.fluid_color({"c","h"}),--{r = 0.5, g = 0.5, b = 0.5},
      max_temperature = 100,
      pressure_to_speed_ratio = 0.4,
      flow_to_energy_ratio = 0.59
    },
    ...
    },
    {
      ...
      default_temperature = 25,
      heat_capacity = "0.1KJ",
      base_color = angelsmods.functions.fluid_color({"c","h"}),--{r = 0.6, g = 0.6, b = 0.6},
      flow_color = angelsmods.functions.fluid_color({"c","h"}),--{r = 0.6, g = 0.6, b = 0.6},
      max_temperature = 100,
      pressure_to_speed_ratio = 0.4,
      flow_to_energy_ratio = 0.59
    },
    ...
    },
    {
      ...
      default_temperature = 25,
      heat_capacity = "0.1KJ",
      base_color = angelsmods.functions.fluid_color({"c","h2"}),--{r = 0.65, g = 0.65, b = 0.65},
      flow_color = angelsmods.functions.fluid_color({"c","h2"}),--{r = 0.65, g = 0.65, b = 0.65},
      max_temperature = 100,
      pressure_to_speed_ratio = 0.4,
      flow_to_energy_ratio = 0.59
    },
