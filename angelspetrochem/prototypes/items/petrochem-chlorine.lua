...
data:extend(
  {
    --CHLORINE
    {
      ...
      gas_temperature = 25,
      heat_capacity = "0.1KJ",
      base_color = angelsmods.functions.fluid_color({"c","l2"}),--{r = 0, g = 1, b = 0},
      flow_color = angelsmods.functions.flow_color({"c","l2"}),--{r = 0, g = 1, b = 0},
      max_temperature = 100,
    },
    {
      type = "fluid",
      ...
      gas_temperature = 25,
      heat_capacity = "0.1KJ",
      base_color = angelsmods.functions.fluid_color({"h","l"}),--{r = 0.1, g = 1, b = 0.1},
      flow_color = angelsmods.functions.flow_color({"h","l"}),--{r = 0.1, g = 1, b = 0.1},
      max_temperature = 100,
    },
    {
      type = "fluid",
      ...
      gas_temperature = 25,
      heat_capacity = "0.1KJ",
      base_color = angelsmods.functions.fluid_color({"h2","l2","w"}),--{r = 0.5, g = 1, b = 0.5},
      flow_color = angelsmods.functions.flow_color({"h2","l2","w"}),--{r = 0.5, g = 1, b = 0.5},
      max_temperature = 100,
    },
    {
      type = "fluid",
      ...
      gas_temperature = 25,
      heat_capacity = "0.1KJ",
      base_color = angelsmods.functions.fluid_color({"c3","h5","l","o"}),--{r = 0.2, g = 1, b = 0.2},
      flow_color = angelsmods.functions.flow_color({"c3","h5","l","o"}),--{r = 0.2, g = 1, b = 0.2},
      max_temperature = 100,
    },
    {
      type = "fluid",
      ...
      gas_temperature = 25,
      heat_capacity = "0.1KJ",
      base_color = angelsmods.functions.fluid_color({"c3","h5","l"}),--{r = 0.3, g = 1, b = 0.3},
      flow_color = angelsmods.functions.flow_color({"c3","h5","l"}),--{r = 0.3, g = 1, b = 0.3},
      max_temperature = 100,
    },
    {
      type = "fluid",
      ...
      gas_temperature = 25,
      heat_capacity = "0.1KJ",
      base_color = angelsmods.functions.fluid_color({"c","h3","l"}),--{r = 0.1, g = 0.8, b = 0.1},
      flow_color = angelsmods.functions.flow_color({"c","h3","l"}),--{r = 0.1, g = 0.8, b = 0.1},
      max_temperature = 100,
    },
    {
      type = "item",
    ...
    },
    {
      ...
      default_temperature = 25,
      heat_capacity = "0.1KJ",
      base_color = angelsmods.functions.fluid_color({"h2","l2","o8","w"}),--{r = 0.5, g = 1, b = 0.5},
      flow_color = angelsmods.functions.flow_color({"h2","l2","o8","w"}),--{r = 0.5, g = 1, b = 0.5},
      max_temperature = 100,
    },
    {
      type = "fluid",
      ...
      gas_temperature = 25,
      heat_capacity = "0.1KJ",
      base_color = angelsmods.functions.fluid_color({"c","o","l2"}),--{r = 0.4, g = 1, b = 0.4},
      flow_color = angelsmods.functions.flow_color({"c","o","l2"}),--{r = 0.4, g = 1, b = 0.4},
      max_temperature = 100,
    },
    {
      type = "fluid",
      ...
      default_temperature = 25,
      heat_capacity = "0.1KJ",
      base_color = angelsmods.functions.fluid_color({"r4","l3","w"}),--{r = 99 / 255, g = 146 / 255, b = 191 / 255},
      flow_color = angelsmods.functions.flow_color({"r4","l3","w"}),--{r = 99 / 255, g = 146 / 255, b = 191 / 255},
      max_temperature = 100,
    },
    {
      type = "fluid",
      ...
      default_temperature = 25,
      heat_capacity = "0.1KJ",
      base_color = angelsmods.functions.fluid_color({"u4","l2","w"}),--{r = 165 / 255, g = 93 / 255, b = 51 / 255},
      flow_color = angelsmods.functions.flow_color({"u4","l2","w"}),--{r = 165 / 255, g = 93 / 255, b = 51 / 255},
      max_temperature = 100,
    },
  }
)