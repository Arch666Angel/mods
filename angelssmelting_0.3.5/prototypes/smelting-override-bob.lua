...
angelsmods.functions.OV.disable_recipe({ "angels-wire-silver", "angels-wire-coil-silver-casting", "angels-wire-coil-silver-casting-fast", "angels-wire-coil-silver-converting" })
...
if data.raw.item["tinned-copper-cable"] then
	...
	angelsmods.functions.OV.disable_recipe({ "solder-alloy" })
end
