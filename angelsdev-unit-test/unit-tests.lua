...
local unit_tests_result = unit_test_functions.test_succesfull
...
local execute_unit_tests = function()
  ...
  for unit_test_index, unit_test_func in pairs(unit_tests) do
    ...
    if unit_test_result == unit_test_functions.test_succesfull then
    ...
    elseif unit_test_result == unit_test_functions.test_failed then -- soft failure
      ...
      if unit_tests_result == unit_test_functions.test_succesfull then unit_tests_result = unit_test_functions.test_failed end
  ...
  if unit_tests_result == unit_test_functions.test_succesfull then
