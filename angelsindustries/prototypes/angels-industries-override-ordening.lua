...
if angelsmods.industries.overhaul then
  ...
  if bobmods and bobmods.logistics then
    ...
    data:extend({
      { type = "item-subgroup", name = "angels-chests-small-c", group = "angels-logistics", order = "aa[chests-small]-b" },
      { type = "item-subgroup", name = "angels-chests-small-d", group = "angels-logistics", order = "aa[chests-small]-c" },
    })
    -- repair packs
  ...
  if bobmods and bobmods.power then
    ...
    if data.raw.item["medium-electric-pole-2"] then
      data:extend({
        { type = "item-subgroup", name = "angels-medium-power-poles", group = "angels-power", order = "e[power-poles]-b[medium]" },
        { type = "item-subgroup", name = "angels-big-power-poles", group = "angels-power", order = "e[power-poles]-c[big]" },
        { type = "item-subgroup", name = "angels-sub-power-poles", group = "angels-power", order = "e[power-poles]-d[substation]" },
      })
    ...
    if data.raw.item["boiler-2"] then
      data:extend({
        { type = "item-subgroup", name = "angels-power-steam-boiler", group = "angels-power", order = "a[steam]-b[boiler]" },
        { type = "item-subgroup", name = "angels-power-steam-generator", group = "angels-power", order = "a[steam]-c[steam-generator]" },
      })
    ...
    if data.raw.item["fluid-generator"] then
      data:extend({
        { type = "item-subgroup", name = "angels-power-fluid-generator", group = "angels-power", order = "a[steam]-d[fluid-generator]" },
      })
    ...
    if data.raw.item["solar-panel-small"] then
      data:extend({
        { type = "item-subgroup", name = "angels-power-solar-panel", group = "angels-power", order = "b[solar]-b[panel]" },
      })
    ...
    if data.raw.item["large-accumulator"] then
      data:extend({
        { type = "item-subgroup", name = "angels-power-accumulator", group = "angels-power", order = "b[solar]-c[accumulator]" },
      })
    ...
    if data.raw.item["burner-reactor"] then
      data:extend({
        { type = "item-subgroup", name = "angels-power-nuclear-reactor-a", group = "angels-power", order = "c[nuclear]-b[burner-reactor]" },
      })
    ...
    if data.raw.item["nuclear-reactor-2"] then
      data:extend({
        { type = "item-subgroup", name = "angels-power-nuclear-reactor-b", group = "angels-power", order = "c[nuclear]-c[nuclear-reactor]" },
      })
    ...
    if data.raw.item["heat-pipe-2"] then
      data:extend({
        { type = "item-subgroup", name = "angels-power-nuclear-heat-pipe", group = "angels-power", order = "c[nuclear]-d[heat-pipe]" },
      })
    ...
    if data.raw.item["heat-exchanger-2"] then
      data:extend({
        { type = "item-subgroup", name = "angels-power-nuclear-heat-exchanger", group = "angels-power", order = "c[nuclear]-e[heat-exchanger]" },
      })
  ...
  if bobmods and bobmods.plates then
    ...
    move_item("uranium-processing", "angels-power-nuclear-processing", "a[refined-ore]-a[processing]-a[uranium]", "recipe")
    ...
    move_item("nuclear-fuel-reprocessing", "angels-power-nuclear-processing", "b[fuel-cell]-b[reprocessing]-a[uranium]", "recipe")
    move_item("used-up-deuterium-fuel-cell", "angels-power-nuclear-processing", "b[fuel-cell]-b[used]-c[deuterium]")
    move_item("deuterium-fuel-reprocessing", "angels-power-nuclear-processing", "b[fuel-cell]-b[reprocessing]-c[deuterium]", "recipe")

    if data.raw.item["thorium-ore"] then
      move_item("thorium-232", "angels-power-nuclear-processing", "a[refined-ore]-d")
      move_item("thorium-processing", "angels-power-nuclear-processing", "a[refined-ore]-a[processing]-b[thorium]", "recipe")

      move_item("kovarex-enrichment-process", "angels-power-nuclear-processing", "a[refined-ore]-b[enrichment]-a[uranium]", "recipe")
      move_item("bobingabout-enrichment-process", "angels-power-nuclear-processing", "a[refined-ore]-b[enrichment]-b[thorium]", "recipe")
      ...
      move_item("thorium-fuel-reprocessing", "angels-power-nuclear-processing", "b[fuel-cell]-b[reprocessing]-b[thorium]", "recipe")
    end
