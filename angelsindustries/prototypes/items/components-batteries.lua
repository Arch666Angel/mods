if angelsmods.industries.components then
  data:extend({
    ...
    -----------------------------------------------------------------------------
    {
      type = "item",
      name = "battery-1",
      icon = "__angelsindustriesgraphics__/graphics/icons/battery-lead.png",
      icon_size = 32,
    ...
    },
    {
      type = "item",
      name = "battery-2",
      icon = "__angelsindustriesgraphics__/graphics/icons/battery-nickel.png",
      icon_size = 32,
      subgroup = "angels-batteries",
      order = "b",
      stack_size = 200,
    },
    {
      type = "item",
      name = "battery-3",
      icon = "__angelsindustriesgraphics__/graphics/icons/battery-lithium-ion.png",
      icon_size = 32,
      subgroup = "angels-batteries",
      order = "c",
      stack_size = 200,
    },
    {
      type = "item",
      name = "battery-4",
      icon = "__angelsindustriesgraphics__/graphics/icons/battery-lithium-polymer.png",
      icon_size = 32,
      subgroup = "angels-batteries",
      order = "d",
      stack_size = 200,
    },
    {
      type = "item",
      name = "battery-5",
      icon = "__angelsindustriesgraphics__/graphics/icons/battery-lithium-glass.png",
      icon_size = 32,
      subgroup = "angels-batteries",
      order = "e",
      stack_size = 200,
    },
    {
      type = "item",
      name = "battery-6",
      icon = "__angelsindustriesgraphics__/graphics/icons/battery-zinc.png",
      icon_size = 32,
      subgroup = "angels-batteries",
      order = "f",
      stack_size = 200,
    ...
    },
    {
      ...
      icons = { { icon = "__angelsindustriesgraphics__/graphics/icons/battery_component_frame.png" } },
      icon_size = 64,
      subgroup = "angels-battery-casings",
      order = "d",
      stack_size = 200,
    ...
    -----------------------------------------------------------------------------
    {
      ...
      icons = {
        {
          icon = "__angelsindustriesgraphics__/graphics/icons/battery_component_A.png",
          tint = { r = 66 / 255, g = 67 / 255, b = 78 / 255 },
        },
      },
      icon_size = 64,
    ...
    },
    {
      ...
      icons = {
        {
          icon = "__angelsindustriesgraphics__/graphics/icons/battery_component_C.png",
          tint = { r = 66 / 255, g = 67 / 255, b = 78 / 255 },
        },
      },
      icon_size = 64,
    ...
    -----------------------------------------------------------------------------
    {
      ...
      icons = {
        {
          icon = "__angelsindustriesgraphics__/graphics/icons/battery_component_electrolyte.png",
    ...
    },
    {
      ...
      icons = { { icon = "__angelsindustriesgraphics__/graphics/icons/battery_component_electrolyte.png" } },
      icon_size = 64,
      subgroup = "angels-electrolytes",
      order = "d",
      default_temperature = 0,
