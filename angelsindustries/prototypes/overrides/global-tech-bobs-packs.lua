...
if angelsmods.industries.tech then
  ...
  if mods["bobmodules"] then
    ...
    AI.pack_replace("angels-bio-yield-module-3", "blue", "blue")
    ...
    AI.pack_replace("speed-module-2", "blue", "orange")
    ...
    AI.pack_replace("efficiency-module-2", "blue", "orange")
    ...
    AI.pack_replace("productivity-module-2", "blue", "orange")
    ...
    AI.pack_replace("pollution-clean-module-1", "blue", "orange")
    AI.pack_replace("pollution-clean-module-2", "blue", "orange")
    ...
    AI.pack_replace("pollution-create-module-1", "blue", "orange")
    AI.pack_replace("pollution-create-module-2", "blue", "orange")
    ...
    AI.pack_replace("raw-speed-module-1", "blue", "orange")
    AI.pack_replace("raw-speed-module-2", "blue", "orange")
    ...
    AI.pack_replace("green-module-1", "blue", "orange")
    AI.pack_replace("green-module-2", "blue", "orange")
    ...
    AI.pack_replace("raw-productivity-module-1", "blue", "orange")
    AI.pack_replace("raw-productivity-module-2", "blue", "orange")
    ...
    AI.pack_replace("god-module-1", "blue", "orange")
  ...
  if mods["bobwarfare"] then
    ...
    AI.pack_replace("bob-plasma-turrets-1", "blue", "orange")
    AI.pack_replace("bob-plasma-turrets-2", "green", "blue")
