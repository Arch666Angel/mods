...
function table_rows(table_chk)
  ...
  if type(table_chk)=="table" then
    for _ in pairs(table_chk) do ct=ct+1 end
  end
  return ct
end
...
function replace_blocks_list(ing_list)--specifically build to be used for replace_con_mats function
  ...
  while (n<rows+1) do
    ...
    if mods['bobplates'] then
      ...
      if ing_list[n].name=="basic-circuit-board"      then ing_list[n].name="block-electronics-0" end
      if ing_list[n].name=="basic-electronic-board"   then ing_list[n].name="block-electronics-1" end
      if ing_list[n].name=="advanced-processing-unit" then ing_list[n].name="block-electronics-5" end
      --bobs gears
      if ing_list[n].name=="steel-gear-wheel"         then ing_list[n].name="angels-gear" end --swap the gear from the iron gear wheel
      if ing_list[n].name=="brass-gear-wheel"         then ing_list[n].name="angels-axle" end --no brass component, take the steel level
      if ing_list[n].name=="cobalt-steel-gear-wheel"  then ing_list[n].name="angels-roller-chain" end --no cobalt-steel component, replace with aluminium
      if ing_list[n].name=="titanium-gear-wheel"      then ing_list[n].name="angels-spring" end
      if ing_list[n].name=="tungsten-gear-wheel"      then ing_list[n].name="angels-bearing" end
      --bobs plates
      if ing_list[n].name=="aluminium-plate"          then ing_list[n].name="construction-frame-3" end
      if ing_list[n].name=="titanium-plate"           then ing_list[n].name="construction-frame-4" end
      if ing_list[n].name=="tungsten-plate"           then ing_list[n].name="construction-frame-5" end
      --bobs pipes (T1: copper, iron, stone, steel, bronze,plastic, brass) others T2
      if ing_list[n].name=="copper-pipe"              then ing_list[n].name="block-fluidbox-1" end
      if ing_list[n].name=="stone-pipe"               then ing_list[n].name="block-fluidbox-1" end
      if ing_list[n].name=="steel-pipe"               then ing_list[n].name="block-fluidbox-1" end
      if ing_list[n].name=="bronze-pipe"              then ing_list[n].name="block-fluidbox-1" end
      if ing_list[n].name=="plastic-pipe"             then ing_list[n].name="block-fluidbox-1" end
      if ing_list[n].name=="brass-pipe"               then ing_list[n].name="block-fluidbox-1" end
      if ing_list[n].name=="titanium-pipe"            then ing_list[n].name="block-fluidbox-2" end
      if ing_list[n].name=="ceramic-pipe"             then ing_list[n].name="block-fluidbox-2" end
      if ing_list[n].name=="tungsten-pipe"            then ing_list[n].name="block-fluidbox-2" end
      if ing_list[n].name=="nitinol-pipe"             then ing_list[n].name="block-fluidbox-2" end
      if ing_list[n].name=="copper-tungsten-pipe"     then ing_list[n].name="block-fluidbox-2" end
      --bobs wire
      if ing_list[n].name=="tinned-copper-cable"      then ing_list[n].name="cable-harness-2" end
      if ing_list[n].name=="insulated-cable"          then ing_list[n].name="cable-harness-3" end
      if ing_list[n].name=="gilded-copper-cable"      then ing_list[n].name="cable-harness-4" end
    end
    ...
    if ing_list[n].name=="stone-brick"            then ing_list[n].name="block-construction-2" end
    if ing_list[n].name=="concrete"               then ing_list[n].name="block-construction-4" end
    --metallic replacements (iron/steel/plastic)
    if ing_list[n].name=="iron-plate"             then ing_list[n].name="construction-frame-1" end
    if ing_list[n].name=="steel-plate"            then ing_list[n].name="construction-frame-2" end
    --if ing_list[n].name=="copper-plate"           then ing_list[n].name="construction-frame-1" end
    --electronics
    if ing_list[n].name=="electronic-circuit"     then ing_list[n].name="block-electronics-1" end
    if ing_list[n].name=="advanced-circuit"       then ing_list[n].name="block-electronics-2" end
    if ing_list[n].name=="processing-unit"        then ing_list[n].name="block-electronics-4" end
    --intermediates
    if ing_list[n].name=="iron-stick"             then ing_list[n].name="construction-components" end
    if ing_list[n].name=="iron-gear-wheel"        then ing_list[n].name="mechanical-parts" end
    if ing_list[n].name=="copper-cable"           then ing_list[n].name="cable-harness-1" end
    if ing_list[n].name=="pipe"                   then ing_list[n].name="block-fluidbox-1" end
    if ing_list[n].name=="engine-unit"            then ing_list[n].name="motor-2" end
    if ing_list[n].name=="electric-engine-unit"   then ing_list[n].name="motor-4" end
    n=n+1
  end
end
