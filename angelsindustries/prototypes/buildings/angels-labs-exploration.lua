...
if angelsmods.industries.tech then
  data:extend({
    --EXPLORATION LAB
    {
      ...
      icons = angelsmods.functions.add_number_icon_layer({
        {
          icon = "__angelsindustriesgraphics__/graphics/icons/exploration-lab-ico.png",
          icon_size = 32,
        },
    ...
    },
    {
      ...
      on_animation = {
        filename = "__angelsindustriesgraphics__/graphics/entity/exploration-lab/exploration-lab.png",
        width = 160,
        height = 160,
        frame_count = 36,
        line_length = 6,
      ...
      off_animation = {
        filename = "__angelsindustriesgraphics__/graphics/entity/exploration-lab/exploration-lab-off.png",
        width = 160,
        height = 160,
        frame_count = 1,
        shift = { 0, 0 },
  ...
  -- angelsmods.trigger.lab_ignore_token["angels-exploration-lab-1"] = true
  -- angelsmods.trigger.lab_ignore_token["angels-exploration-lab-2"] = true
  angelsmods.trigger.lab_ignore_token["angels-exploration-lab-3"] = true
end
