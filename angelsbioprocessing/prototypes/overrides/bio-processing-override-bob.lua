  ...
  if mods["bobplates"] then
    ...
    if angelsmods.industries and angelsmods.industries.overhaul then
      if data.raw["item-group"]["bob-gems"] then
        ...
        data.raw["item-subgroup"]["bio-biter-processing-raw"].order =
          "7" .. data.raw["item-subgroup"]["bio-biter-processing-raw"].order
        data.raw["item-subgroup"]["bio-biter-processing-cutting"].group = "bob-gems"
        data.raw["item-subgroup"]["bio-biter-processing-cutting"].order =
          "7" .. data.raw["item-subgroup"]["bio-biter-processing-cutting"].order
        data.raw["item-subgroup"]["bio-biter-processing-powder"].group = "bob-gems"
        data.raw["item-subgroup"]["bio-biter-processing-powder"].order =
          "7" .. data.raw["item-subgroup"]["bio-biter-processing-powder"].order
