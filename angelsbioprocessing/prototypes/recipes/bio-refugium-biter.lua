data:extend({
  ...
  ---------------------------------------------------------------------------
  {
    ...
    results = {
      { type = "item", name = "angels-biter-small", amount = 1, independent_probability = 0.95 },
      { type = "item", name = "angels-biter-queen-small", amount = 1, independent_probability = 0.05 },
    },
  ...
  },
  {
    ...
    results = {
      { type = "item", name = "angels-biter-medium", amount = 1, independent_probability = 0.975 },
      { type = "item", name = "angels-biter-queen-medium", amount = 1, independent_probability = 0.025 },
    },
  ...
  },
  {
    ...
    results = {
      { type = "item", name = "angels-biter-big", amount = 1, independent_probability = 0.99 },
      { type = "item", name = "angels-biter-queen-big", amount = 1, independent_probability = 0.01 },
    },
