data:extend(
{
  ...
  },
  {
    ...
    results=
    {
      ...
      {type="item", name="alien-fish-1-raw", amount=1, probability = 0.85, show_details_in_recipe_tooltip=false},
      {type="fluid", name="liquid-polluted-fish-atmosphere", amount=20},
    },
  ...
  },
  {
    ...
    results=
    {
      ...
      {type="item", name="alien-fish-2-raw", amount=1, probability = 0.85, show_details_in_recipe_tooltip=false},
      {type="fluid", name="liquid-polluted-fish-atmosphere", amount=20},
    },
  ...
  },
  {
    ...
    results=
    {
      ...
      {type="item", name="alien-fish-3-raw", amount=1, probability = 0.85, show_details_in_recipe_tooltip=false},
      {type="fluid", name="liquid-polluted-fish-atmosphere", amount=20},
    },
