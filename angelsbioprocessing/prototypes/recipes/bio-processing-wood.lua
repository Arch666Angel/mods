data:extend({
  ...
  -- RAW WOOD PROCESSING
  {
    ...
    --icon_size = 32,
    localised_name = { "item-name.angels-solid-saw" },
    category = "crafting",
    subgroup = "bio-wood",
    enabled = false,
    energy_required = 0.5,
  ...
  },
  {
    ...
    --icon_size = 32,
    localised_name = { "item-name.angels-solid-crystal-tipped-saw" },
    category = "crafting",
    subgroup = "bio-wood",
    enabled = false,
    energy_required = 2,
  ...
  },
  {
    ...
    --icon_size = 32,
    localised_name = { "item-name.angels-solid-crystal-full-saw" },
    category = "crafting",
    subgroup = "bio-wood",
    enabled = false,
    energy_required = 5,
