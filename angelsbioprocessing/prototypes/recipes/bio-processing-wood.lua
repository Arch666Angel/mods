data:extend({
  ...
  -- SPECIAL TREE GENERATION
  {
    ...
    results = {
      { type = "item", name = "angels-temperate-tree", amount = 1, shared_probability = { min = 0.00, max = 0.25 }},
      { type = "item", name = "angels-swamp-tree",     amount = 1, shared_probability = { min = 0.25, max = 0.50 }},
      { type = "item", name = "angels-desert-tree",    amount = 1, shared_probability = { min = 0.50, max = 0.75 }},
    },
    icons = {
      {
  ...
  },
  {
    ...
    results = {
      { type = "item", name = "wood", amount_min = 6, amount_max = 8 },
      {
        ...
        ignored_by_productivity = 1,
        ignored_by_stats = 1,
        shared_probability = { min = 0, max = 0.95 },
      },
      {
        type = "item",
        name = "angels-solid-saw",
  ...
  },
  {
    ...
    results = {
      { type = "item", name = "wood", amount_min = 6, amount_max = 8 },
      {
        ...
        ignored_by_productivity = 1,
        ignored_by_stats = 1,
        shared_probability = { min = 0, max = 0.99 },
      },
      {
        type = "item",
        name = "angels-solid-crystal-tipped-saw",
        ...
        ignored_by_productivity = 1,
        ignored_by_stats = 1,
        shared_probability = { min = 0.99, max = 1 },
      },
    },
    main_product = "wood",
    allow_decomposition = false,
  ...
  -- TEMPERATE WOOD GENERATOR
  {
    ...
    categories = { "angels-tree-temperate" },
