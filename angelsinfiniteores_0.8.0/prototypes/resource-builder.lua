	...
	if input.glow == true then
		...
		if input.sheet == 1 then
			if input.glow_var == 1 then
				local gfx_ani_per = 3.5
				local gfx_ani_dev = 0.7
				local gfx_dark_mul = 3
				local gfx_alpha_min = 0.3
				local gfx_alpha_max = 0.8
			else
				local gfx_ani_per = 4
				local gfx_ani_dev = 0.8
				local gfx_dark_mul = 3
				local gfx_alpha_min = 0.3
				local gfx_alpha_max = 0.7
			end
			return
				{
				sheet =
		...
		if input.sheet == 4 then
			local gfx_ani_per = 5
			local gfx_ani_dev = 1
			local gfx_dark_mul = 3.6
			local gfx_alpha_min = 0.2
			local gfx_alpha_max = 0.3
			return
			{
			  sheet =
			  {
