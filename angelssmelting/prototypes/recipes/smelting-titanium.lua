data:extend({
  ...
  },
  {
    ...
    categories = { "angels-pellet-pressing-3" },
    subgroup = "angels-titanium",
    energy_required = 2,
    enabled = false,
    auto_recycle = false,
  ...
  -- SMELTING RESULTS
  {
    ...
    categories = { "angels-blast-smelting-3" },
    subgroup = "angels-titanium",
    energy_required = 4,
    enabled = false,
    auto_recycle = false,
  ...
  },
  {
    ...
    categories = { "angels-powderizing-3" },
    subgroup = "angels-titanium",
    energy_required = 0.5,
    enabled = false,
    auto_recycle = false,
  ...
  },
  {
    ...
    categories = { "angels-strand-casting-3" },
    subgroup = "angels-titanium-casting",
    enabled = false,
    auto_recycle = false,
    energy_required = 4,
  ...
  },
  {
    ...
    categories = { "angels-strand-casting-4" },
    subgroup = "angels-titanium-casting",
    enabled = false,
    auto_recycle = false,
    energy_required = 2,
