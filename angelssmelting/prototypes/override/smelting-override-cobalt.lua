...
if angelsmods.trigger.smelting_products["cobalt"].ingot then
  ...
  angelsmods.functions.hide("liquid-molten-cobalt")
  OV.disable_recipe({ "processed-cobalt", "pellet-cobalt", "cobalt-ore-processing-alt" })
  OV.disable_recipe({ "solid-cobalt-hydroxide", "processed-cobalt-smelting", "solid-cobalt-hydroxide-smelting" })
