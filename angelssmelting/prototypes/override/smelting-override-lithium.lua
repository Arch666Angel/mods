...
then
  angelsmods.functions.move_item(mods["bobplates"] and "solid-lithum" or "bob-lithium-chloride", "angels-alloys", "b[lithium]-a")
  ...
  OV.patch_recipes({
    { name = mods["bobplates"] and "solid-lithum" or "bob-lithium-chloride", subgroup = "angels-alloys", order = "b[lithium]-a" },
