...
if angelsmods.functions.is_special_vanilla() then
  ...
  if mods["angelspetrochem"] then
    ...
    table.insert(
      items,
      { "tips-and-tricks-misc.a-gives-b", "[fluid=angels-water-red-waste]", "[item=angels-solid-sodium-nitrate]" }
    )
    table.insert(
      items,
      { "tips-and-tricks-misc.a-gives-b", "[fluid=angels-water-green-waste]", "[item=angels-solid-salt]" }
    )
    table.insert(
      items,
      { "tips-and-tricks-misc.a-gives-b", "[fluid=angels-water-greenyellow-waste]", "[item=angels-fluorite-ore]" }
    )
