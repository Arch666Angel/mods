...
if not angelsmods.petrochem then
  ...
  if angelsmods.trigger.enableacids then
    ...
    OV.disable_recipe(
      {"red-waste-water-purification", "green-waste-water-purification", "greenyellow-waste-water-purification"}
    )
  end
end
...
if mods["bobplates"] then
  ...
  --LOCALIZATION
  --SINGLE GEM CRYSTALLIZATION
  data.raw.recipe["angelsore7-crystallization-1"].localised_name = {
    "recipe-name.angelsore7-crystallization-1",
    "Sapphire-Ore"
  }
  data.raw.recipe["angelsore7-crystallization-2"].localised_name = {
    "recipe-name.angelsore7-crystallization-2",
    "Topaz-Ore"
  }
  data.raw.recipe["angelsore7-crystallization-3"].localised_name = {
    "recipe-name.angelsore7-crystallization-3",
    "Ruby-Ore"
  }
  data.raw.recipe["angelsore7-crystallization-4"].localised_name = {
    "recipe-name.angelsore7-crystallization-4",
    "Emerald-Ore"
  }
  data.raw.recipe["angelsore7-crystallization-5"].localised_name = {
    "recipe-name.angelsore7-crystallization-5",
    "Amethyst-Ore"
  }
  data.raw.recipe["angelsore7-crystallization-6"].localised_name = {
    "recipe-name.angelsore7-crystallization-6",
    "Diamond-Ore"
  }
else
  OV.disable_recipe(
...
if data.raw.item["thorium-ore"] then
  ...
  table.insert(
    data.raw.technology["ore-electro-whinning-cell"].effects,
    {type = "unlock-recipe", recipe = "angelsore-crystal-mix6-processing"}
  )
