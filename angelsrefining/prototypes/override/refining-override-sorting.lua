  ...
  merge_table_of_tables {
    ...
    create_sorting_recipes(
      ...
      "angelsore1%s",
      {
        ...
        ["iron-ore"] = special_vanilla and {1, 2, 6, 4} or {2, 2, 3, 3},
        ["angels-iron-nugget"] = special_vanilla and {1, 1, 1, 2},
        ["angels-iron-pebbles"] = special_vanilla and {2, 4, 4, 4},
    ...
    create_sorting_recipes(
      ...
      "angelsore2%s",
      {
        ...
        ["angels-iron-nugget"] = special_vanilla and {2, 2, 0, 2},
        ["angels-iron-pebbles"] = special_vanilla and {1, 2, 4, 6},
        ["angels-iron-slag"] = special_vanilla and {0, 0, 0, 1},
        ["copper-ore"] = (not special_vanilla) and {1, 1, 1, 2},
    ...
    create_slag_recipes(
      "slag-processing%s",
      {
        ...
        ["manganese-ore"] = {
          ...
          0,
          0,
          ore_exists("platinum-ore") and ore_exists("chrome-ore") and 0.4 or ore_exists("chrome-ore") and 0.2 or 0.4,
          0,
          0,
          0
        },
        ["chrome-ore"] = {
          ...
          0,
          0,
          ore_exists("platinum-ore") and 0 or 0.2,
          ore_exists("platinum-ore") and 0.4 or 0,
          0,
          0
        },
      ...
      {
        --[[1]] special_vanilla and "__angelsrefining__/graphics/icons/slag-processing-vanilla1.png" or
        ...
        --[[2]] special_vanilla and "__angelsrefining__/graphics/icons/slag-processing-vanilla2.png" or
          angelsmods.functions.create_liquid_recipe_icon(
            {
              "lead-ore",
              "tin-ore"
        ...
        --[[4]] special_vanilla and "__angelsrefining__/graphics/icons/slag-processing-vanilla3.png" or
          angelsmods.functions.create_liquid_recipe_icon(
            {
              "gold-ore",
              "nickel-ore"
