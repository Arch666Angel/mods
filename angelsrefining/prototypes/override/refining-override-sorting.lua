  ...
  OV.patch_recipes({
    {
      ...
      results = {
        { "!!" },
        { type = "item", name = "angels-ore1", amount = 1, shared_probability = { min = 0.0, max = 0.4 }},
        { type = "item", name = "angels-ore4", amount = 1, shared_probability = { min = 0.4, max = 0.8 }},
      },
    ...
    },
    {
      ...
      results = {
        { "!!" },
        { type = "item", name = "angels-ore2", amount = 1, shared_probability = { min = 0.0, max = 0.4 }},
        { type = "item", name = "angels-ore3", amount = 1, shared_probability = { min = 0.4, max = 0.8 }},
      },
      icons = angelsmods.functions.create_liquid_recipe_icon({
        "angels-ore2",
        "angels-ore3",
  ...
  OV.patch_recipes({
    {
      ...
      results = {
        { "!!" },
        { type = "item", name = "angels-ore1", amount = 1, shared_probability = { min = 0.0, max = 0.4 }},
        { type = "item", name = "angels-ore6", amount = 1, shared_probability = { min = 0.4, max = 0.8 }},
      },
      icons = angelsmods.functions.create_liquid_recipe_icon({
        "angels-ore1",
        "angels-ore6",
    ...
    },
    {
      ...
      results = {
        { "!!" },
        { type = "item", name = "angels-ore3", amount = 1, shared_probability = { min = 0.0, max = 0.4 }},
        { type = "item", name = "angels-ore5", amount = 1, shared_probability = { min = 0.4, max = 0.8 }},
      },
      icons = angelsmods.functions.create_liquid_recipe_icon({
        "angels-ore3",
        "angels-ore5",
