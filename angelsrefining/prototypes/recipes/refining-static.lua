...
data:extend({
  ...
  },
  {
    ...
    ingredients = {
      ...
      { type = "item", name = "filter-ceramic", amount = 2 },
    },
    results = {
      { type = "fluid", name = "mineral-sludge", amount = 100 },
      { type = "fluid", name = "water-yellow-waste", amount = 65 },
      { type = "item", name = "filter-ceramic-used", amount = 2 },
    },
    icons = angelsmods.functions.create_viscous_liquid_filtering_recipe_icon(
      "ceramic",
      { { 140, 073, 029 }, { 230, 116, 017 } }
  ...
  },
  {
    ...
    enabled = false,
    ingredients = {
      { type = "fluid", name = "crystal-slurry", amount = 100 },
      { type = "fluid", name = "water-purified", amount = 100 },
      { type = "item", name = "filter-ceramic", amount = 2 },
    },
    results = {
      { type = "fluid", name = "crystal-seedling", amount = 100 },
      { type = "fluid", name = "water-yellow-waste", amount = 65 },
      { type = "item", name = "filter-ceramic-used", amount = 2 },
    },
    icons = angelsmods.functions.create_viscous_liquid_filtering_recipe_icon(
