data:extend({
  ...
  --TIER 2.5
  {
    ...
    icons = {
      ...
      { icon = "__angelsrefininggraphics__/graphics/icons/angels-ore8-dust.png", scale = 0.5, shift = { -10, 10 } },
    },
    icon_size = 32,
    order = "h",
  },
  {
    ...
    icons = {
      { icon = "__angelsrefininggraphics__/graphics/icons/sort-icon.png" },
      { icon = "__angelsrefininggraphics__/graphics/icons/angels-ore9-dust.png", scale = 0.5, shift = { -10, 10 } },
    },
    icon_size = 32,
    order = "j",
  },
