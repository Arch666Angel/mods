...
OV.patch_recipes(
  {
    --1-IRON
    {
      ...
      results = {{"!!"}, {name = "iron-ore", type = "item", amount = 1, probability = 0.8}},
      icon = "__angelsrefining__/graphics/icons/slag-processing-vanilla1.png"
    },
    --2-COPPER
    {
      name = "slag-processing-2",
      results = {{"!!"}, {name = "copper-ore", type = "item", amount = 1, probability = 0.8}},
      icon = "__angelsrefining__/graphics/icons/slag-processing-vanilla2.png"
    },
    --4-IRON-PEBBLES,
    {
      name = "slag-processing-4",
      results = {{"!!"}, {name = "angels-iron-pebbles", type = "item", amount = 3, probability = 0.8}},
      icon = "__angelsrefining__/graphics/icons/slag-processing-vanilla3.png"
    },
    --5-COPPER-PEBBLES,
    {
      name = "slag-processing-5",
      results = {{"!!"}, {name = "angels-copper-pebbles", type = "item", amount = 3, probability = 0.8}},
      icon = "__angelsrefining__/graphics/icons/slag-processing-vanilla4.png"
    }
  }
)
--3-EMPTY,
...
OV.patch_recipes(
  {
    ...
    --CRUSHED (4/3,5)
    {
      ...
      results = {
        {"!!"},
        {name = "iron-ore", type = "item", amount = 1},
        {name = "angels-iron-nugget", type = "item", amount = 1},
        {name = "angels-iron-pebbles", type = "item", amount = 2}
      }
    },
    --CHUNK (6/5,5)
    {
      ...
      results = {
        {"!!"},
        {name = "iron-ore", type = "item", amount = 2},
        {name = "angels-iron-nugget", type = "item", amount = 1},
        {name = "angels-iron-pebbles", type = "item", amount = 4}
      }
    },
    --CRYSTAL (8/7,5)
    {
      ...
      results = {
        {"!!"},
        {name = "iron-ore", type = "item", amount = 4},
        {name = "angels-iron-nugget", type = "item", amount = 1},
        {name = "angels-iron-pebbles", type = "item", amount = 4}
      }
    },
    --PURE (9/8,75)
    {
      ...
      results = {
        {"!!"},
        {name = "iron-ore", type = "item", amount = 4},
        {name = "angels-iron-nugget", type = "item", amount = 2},
        {name = "angels-iron-pebbles", type = "item", amount = 1},
        {name = "angels-iron-slag", type = "item", amount = 1}
      }
    },
    --JIVOLITE (IRON)
    --CRUSHED (4/4,5)
    ...
    --PURE (9/9)
    {
      ...
      results = {
        {"!!"},
        {name = "iron-ore", type = "item", amount = 2},
        {name = "angels-iron-nugget", type = "item", amount = 3},
        {name = "angels-iron-pebbles", type = "item", amount = 2},
        {name = "angels-iron-slag", type = "item", amount = 2}
      }
    },
    --STIRATITE (COPPER)
    --CRUSHED (4/3,5)
    {
      ...
      results = {
        ...
        {name = "angels-copper-nugget", type = "item", amount = 0},
        {name = "angels-copper-pebbles", type = "item", amount = 3}
      }
    },
    --CHUNK (6/5,5)
    {
      ...
      results = {
        {"!!"},
        {name = "copper-ore", type = "item", amount = 2},
        {name = "angels-copper-nugget", type = "item", amount = 1},
        {name = "angels-copper-pebbles", type = "item", amount = 4}
      }
    },
    --CRYSTAL (8/7,5)
    {
      ...
      results = {
        ...
        {name = "angels-copper-nugget", type = "item", amount = 1},
        {name = "angels-copper-pebbles", type = "item", amount = 6}
      }
    },
    --PURE (9/8,75)
    {
      ...
      results = {
        {"!!"},
        {name = "copper-ore", type = "item", amount = 5},
        {name = "angels-copper-nugget", type = "item", amount = 1},
        {name = "angels-copper-pebbles", type = "item", amount = 3},
        {name = "angels-copper-slag", type = "item", amount = 1}
      }
    },
    --CROTINIUM (COPPER)
    --CRUSHED (4/4)
    {
      ...
      results = {
        ...
        {name = "copper-ore", type = "item", amount = 2},
        {name = "angels-copper-nugget", type = "item", amount = 1},
        {name = "angels-copper-pebbles", type = "item", amount = 1}
      }
    },
    --CHUNK (6/6)
    {
      ...
      results = {
        {"!!"},
        {name = "copper-ore", type = "item", amount = 4},
        {name = "angels-copper-nugget", type = "item", amount = 1},
        {name = "angels-copper-pebbles", type = "item", amount = 1}
      }
    },
    --CRYSTAL (8/8)
    {
      ...
      results = {
        {"!!"},
        {name = "copper-ore", type = "item", amount = 4},
        {name = "angels-copper-nugget", type = "item", amount = 2},
        {name = "angels-copper-pebbles", type = "item", amount = 2}
      }
    },
    --PURE (9/9)
    {
      ...
      results = {
        {"!!"},
        {name = "copper-ore", type = "item", amount = 2},
        {name = "angels-copper-nugget", type = "item", amount = 3},
        {name = "angels-copper-pebbles", type = "item", amount = 2},
        {name = "angels-copper-slag", type = "item", amount = 2}
      }
    }
  }
)
...
angelsmods.functions.OV.disable_technology(
  ...
  {
    {
      ...
      ingredients = {
        {"!!"},
        {name = "angels-ore1-crushed", type = "item", amount = 0},
        {name = "angels-ore1-crushed", type = "item", amount = 0},
        {name = "angels-iron-pebbles", type = "item", amount = 4},
        {name = "angels-iron-nugget", type = "item", amount = 1}
      },
    ...
    },
    {
      ...
      ingredients = {
        {"!!"},
        {name = "angels-ore4-crushed", type = "item", amount = 0},
        {name = "angels-ore5-crushed", type = "item", amount = 0},
        {name = "angels-copper-pebbles", type = "item", amount = 4},
        {name = "angels-copper-nugget", type = "item", amount = 1}
      },
  ...
  {
    {
      ...
      ingredients = {
        {"!!"},
        {name = "angels-ore1-chunk", type = "item", amount = 0},
        {name = "angels-ore6-chunk", type = "item", amount = 0},
        {name = "angels-iron-pebbles", type = "item", amount = 3},
        {name = "angels-iron-slag", type = "item", amount = 1}
      },
    ...
    },
    {
      ...
      ingredients = {
        {"!!"},
        {name = "angels-ore1-chunk", type = "item", amount = 0},
        {name = "angels-ore5-chunk", type = "item", amount = 0},
        {name = "angels-copper-pebbles", type = "item", amount = 3},
        {name = "angels-copper-slag", type = "item", amount = 1}
      },
