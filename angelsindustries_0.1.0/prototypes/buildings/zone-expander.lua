circuit_connector_definitions["extender-1"] = circuit_connector_definitions.create
(
...
circuit_connector_definitions["extender-2"] = circuit_connector_definitions.create
(
  universal_connector_template,
  {
...
circuit_connector_definitions["charger"] = circuit_connector_definitions.create
(
  universal_connector_template,
  {
