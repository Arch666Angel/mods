...
funcs.generate_train_entities(
  {
    ...
    pictures = {
      ...
      direction_count = 128,
      filenames = {
        "__angelsaddons-crawlertrain__/graphics/entity/crawler-train/crawler-loco-1.png",
        "__angelsaddons-crawlertrain__/graphics/entity/crawler-train/crawler-loco-2.png"
      },
      line_length = 8,
      lines_per_file = 8,
      shift = {0.0, -0.75}
...
funcs.generate_train_entities(
  {
    ...
    pictures = {
      ...
      direction_count = 128,
      filenames = {
        "__angelsaddons-crawlertrain__/graphics/entity/crawler-train/crawler-loco-wagon-1.png",
        "__angelsaddons-crawlertrain__/graphics/entity/crawler-train/crawler-loco-wagon-2.png"
      },
      line_length = 8,
      lines_per_file = 8,
      shift = {0.0, -0.75}
