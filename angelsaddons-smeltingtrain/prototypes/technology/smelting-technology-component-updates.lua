...
OV.remove_prereq("angels-smelting-train-2", "speed-module") OV.execute()
OV.remove_prereq("angels-smelting-train-2", "effectivity-module") OV.execute()
...
OV.remove_prereq("angels-smelting-train-3", "speed-module-2") OV.execute()
OV.remove_prereq("angels-smelting-train-3", "effectivity-module-2") OV.execute()
...
OV.remove_prereq("angels-smelting-train-4", "speed-module-3") OV.execute()
OV.remove_prereq("angels-smelting-train-4", "effectivity-module-3") OV.execute()
OV.remove_prereq("angels-smelting-train-4", "construction-robotics") OV.execute()
...
OV.remove_prereq("angels-smelting-train-5", "rocket-control-unit") OV.execute()
OV.remove_prereq("angels-smelting-train-5", "logistic-system") OV.execute()
