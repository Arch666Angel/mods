...
if angelsmods.addons.mobility.crawlertrain.enabled then
  ...
  funcs.generate_train_recipe({
    ...
    ingredients = {
      ...
      { name = "efficiency-module", amounts = { 0, 1, 0, 0, 0 } },
      { name = "efficiency-module-2", amounts = { 0, 0, 1, 0, 0 } },
      { name = "efficiency-module-3", amounts = { 0, 0, 0, 1, 0 } },
      { name = "rocket-control-unit", amounts = { 0, 0, 0, 0, 2 } },
  ...
  funcs.generate_train_recipe({
    ...
    ingredients = {
      ...
      { name = "electronic-circuit", amounts = { 15, 0, 0, 0, 0 } },
      { name = "efficiency-module", amounts = { 0, 2, 0, 0, 0 } },
      { name = "efficiency-module-2", amounts = { 0, 0, 2, 0, 0 } },
      { name = "efficiency-module-3", amounts = { 0, 0, 0, 2, 0 } },
