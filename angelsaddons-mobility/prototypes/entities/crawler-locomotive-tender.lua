...
funcs.generate_train_entities({
  ...
  pictures = {
    rotated = {
      layers = {
        util.sprite_load("__angelsaddons-mobility__/graphics/entity/crawler-locomotive-wagon/crawler-locomotive-wagon", {
          dice = 4,
          priority = "very-low",
        ...
        util.sprite_load("__angelsaddons-mobility__/graphics/entity/crawler-locomotive-wagon/crawler-locomotive-wagon-shadow", {
          dice = 4,
          priority = "very-low",
          flags = { "shadow" },
          draw_as_shadow = true,
    ...
    sloped = funcs.use_sloped_train_features and {
      layers = {
        util.sprite_load("__angelsaddons-mobility__/graphics/entity/crawler-locomotive-wagon/crawler-locomotive-wagon-sloped", {
          dice = 4,
          priority = "very-low",
          direction_count = 160,
          scale = 0.5,
        ...
        util.sprite_load("__angelsaddons-mobility__/graphics/entity/crawler-locomotive-wagon/crawler-locomotive-wagon-sloped-shadow", {
          dice = 4,
          priority = "very-low",
          flags = { "shadow" },
          draw_as_shadow = true,
