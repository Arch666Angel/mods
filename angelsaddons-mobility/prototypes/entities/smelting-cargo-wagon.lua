...
funcs.generate_train_entities({
  ...
  pictures = {
    rotated = {
      layers = {
        util.sprite_load("__angelsaddons-mobility__/graphics/entity/smelting-cargo-wagon/smelting-cargo-wagon", {
          dice = 4,
          priority = "very-low",
        ...
        util.sprite_load("__angelsaddons-mobility__/graphics/entity/smelting-cargo-wagon/smelting-cargo-wagon-mask", {
          dice = 4,
          priority = "very-low",
        ...
        util.sprite_load("__angelsaddons-mobility__/graphics/entity/smelting-cargo-wagon/smelting-cargo-wagon-shadow", {
          dice = 4,
          priority = "very-low",
          flags = { "shadow" },
          draw_as_shadow = true,
    ...
    sloped = funcs.use_sloped_train_features and {
      layers = {
        util.sprite_load("__angelsaddons-mobility__/graphics/entity/smelting-cargo-wagon/smelting-cargo-wagon-sloped", {
          dice = 4,
          priority = "very-low",
          direction_count = 80,
          scale = 0.5,
        ...
        util.sprite_load("__angelsaddons-mobility__/graphics/entity/smelting-cargo-wagon/smelting-cargo-wagon-sloped-mask", {
          dice = 4,
          priority = "very-low",
          apply_runtime_tint = true,
          tint_as_overlay = true,
        ...
        util.sprite_load("__angelsaddons-mobility__/graphics/entity/smelting-cargo-wagon/smelting-cargo-wagon-sloped-shadow", {
          dice = 4,
          priority = "very-low",
          flags = { "shadow" },
          draw_as_shadow = true,
  ...
  horizontal_doors = {
    layers = {
      util.sprite_load("__angelsaddons-mobility__/graphics/entity/smelting-cargo-wagon/smelting-cargo-wagon-door-horizontal", {
        frame_count = 8,
        scale = 0.5,
        usage = "train",
      }),
      util.sprite_load("__angelsaddons-mobility__/graphics/entity/smelting-cargo-wagon/smelting-cargo-wagon-door-horizontal-mask", {
        apply_runtime_tint = true,
        tint_as_overlay = true,
        flags = { "mask" },
        frame_count = 8,
      ...
      util.sprite_load("__angelsaddons-mobility__/graphics/entity/smelting-cargo-wagon/smelting-cargo-wagon-door-horizontal-shadow", {
        flags = { "shadow" },
        draw_as_shadow = true,
        frame_count = 8,
        scale = 0.5,
  ...
  vertical_doors = {
    layers = {
      util.sprite_load("__angelsaddons-mobility__/graphics/entity/smelting-cargo-wagon/smelting-cargo-wagon-door-vertical", {
        frame_count = 8,
        scale = 0.5,
        usage = "train",
      }),
      util.sprite_load("__angelsaddons-mobility__/graphics/entity/smelting-cargo-wagon/smelting-cargo-wagon-door-vertical-mask", {
        apply_runtime_tint = true,
        tint_as_overlay = true,
        flags = { "mask" },
        frame_count = 8,
      ...
      util.sprite_load("__angelsaddons-mobility__/graphics/entity/smelting-cargo-wagon/smelting-cargo-wagon-door-vertical-shadow", {
        flags = { "shadow" },
        draw_as_shadow = true,
        frame_count = 8,
        scale = 0.5,
