...
funcs.generate_train_entities({
  ...
  pictures = {
    rotated = {
      layers = {
        util.sprite_load(
          "__angelsaddons-mobility-graphics-smelting__/graphics/entity/smelting-locomotive/smelting-locomotive",
          {
            dice = 4,
            priority = "very-low",
        ...
        util.sprite_load(
          "__angelsaddons-mobility-graphics-smelting__/graphics/entity/smelting-locomotive/smelting-locomotive-mask",
          {
            dice = 4,
            priority = "very-low",
        ...
        util.sprite_load(
          "__angelsaddons-mobility-graphics-smelting__/graphics/entity/smelting-locomotive/smelting-locomotive-running-lights",
          {
            dice = 4,
            priority = "very-low",
            draw_as_light = true,
        ...
        util.sprite_load(
          "__angelsaddons-mobility-graphics-smelting__/graphics/entity/smelting-locomotive/smelting-locomotive-shadow",
          {
            dice = 4,
            priority = "very-low",
            flags = { "shadow" },
    ...
    sloped = funcs.use_sloped_train_features
        and {
          layers = {
            util.sprite_load(
              "__angelsaddons-mobility-graphics-smelting__/graphics/entity/smelting-locomotive/smelting-locomotive-sloped",
              {
                dice = 4,
                priority = "very-low",
                direction_count = 160,
            ...
            util.sprite_load(
              "__angelsaddons-mobility-graphics-smelting__/graphics/entity/smelting-locomotive/smelting-locomotive-sloped-mask",
              {
                dice = 4,
                priority = "very-low",
                apply_runtime_tint = true,
            ...
            util.sprite_load(
              "__angelsaddons-mobility-graphics-smelting__/graphics/entity/smelting-locomotive/smelting-locomotive-sloped-running-lights",
              {
                dice = 4,
                priority = "very-low",
                draw_as_light = true,
            ...
            util.sprite_load(
              "__angelsaddons-mobility-graphics-smelting__/graphics/entity/smelting-locomotive/smelting-locomotive-sloped-shadow",
              {
                dice = 4,
                priority = "very-low",
                flags = { "shadow" },
  ...
  front_light_pictures = {
    rotated = {
      layers = {
        util.sprite_load(
          "__angelsaddons-mobility-graphics-smelting__/graphics/entity/smelting-locomotive/smelting-locomotive-lights",
          {
            dice = 4,
            priority = "very-low",
            blend_mode = "additive",
    ...
    sloped = funcs.use_sloped_train_features
        and {
          layers = {
            util.sprite_load(
              "__angelsaddons-mobility-graphics-smelting__/graphics/entity/smelting-locomotive/smelting-locomotive-sloped-lights",
              {
                dice = 4,
                priority = "very-low",
                blend_mode = "additive",
