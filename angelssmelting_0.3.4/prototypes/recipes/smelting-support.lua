...
--COOLANT
	...
	enabled = "false",
    ingredients ={
	  {type="fluid", name="liquid-coolant-used", amount=100, minimum_temperature = 295},
	...
	enabled = "false",
    ingredients ={
	  {type="fluid", name="liquid-coolant-clean", amount=100, minimum_temperature = 290},
	...
	enabled = "false",
    ingredients ={
	  {type="fluid", name="liquid-coolant-clean", amount=100, minimum_temperature = 190},
	  {type="fluid", name="water", amount=50},
	},
    results=
    {
	...
	enabled = "false",
    ingredients ={
	  {type="fluid", name="liquid-coolant-clean", amount=100, minimum_temperature = 90},
	  {type="fluid", name="water", amount=50},
	},
    results=
    {
