...
--PUFFER
  ...
  },
  {
    ...
    ingredients ={
      ...
      {type="fluid", name="liquid-nutrient-pulp", amount=20},
      {type="fluid", name="gas-puffer-atmosphere", amount=40},
      {type="fluid", name="gas-ammonia", amount=40},
    },
    results=
    {
      ...
      {type="fluid", name="gas-raw-1", amount=40},
    },
  ...
  },
  {
    ...
    ingredients ={
      ...
      {type="fluid", name="liquid-nutrient-pulp", amount=20},
      {type="fluid", name="gas-puffer-atmosphere", amount=40},
      {type="fluid", name="gas-synthesis", amount=40},
    },
    results=
    {
  ...
  },
  {
    ...
    ingredients ={
      ...
      {type="fluid", name="liquid-nutrient-pulp", amount=20},
      {type="fluid", name="gas-puffer-atmosphere", amount=40},
      {type="fluid", name="gas-phosgene", amount=40},
    },
    results=
    {
  ...
  },
  {
    ...
    ingredients ={
      ...
      {type="fluid", name="liquid-nutrient-pulp", amount=20},
      {type="fluid", name="gas-puffer-atmosphere", amount=40},
      {type="fluid", name="gas-hydrazine", amount=40},
    },
    results=
    {
