...
--OVERRIDE FOR BASE
	...
	angelsmods.functions.OV.set_input("rocket-fuel", "gas-hydrazine", "fluid", 30)
	angelsmods.functions.OV.set_input("rocket-fuel", "gas-dimethylhydrazine", "fluid", 30)
	angelsmods.functions.OV.set_input("rocket-fuel", "liquid-nitric-acid", "fluid", 10)   
	angelsmods.functions.OV.set_special_recipe_override("rocket-fuel", { category = "chemistry" })
	angelsmods.functions.OV.add_prereq("rocket-silo", "angels-nitrogen-processing-4") 
